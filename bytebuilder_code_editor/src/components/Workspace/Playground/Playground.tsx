...
const Playground:React.FC<PlaygroundProps> = ({problem,setSuccess, setSolved}) => {
    ...
    const hannleSubmit = async () => {
        ...
        try{
            ...
            if(typeof handler === "function") {
             ...
             if(success){
                toast.success("Congrates! You have solved the problem", {
                    position: "top-center",
                    autoClose: 3000,
                    theme: "dark"
                });
    ...
    return (
        <div className='flex flex-col bg-dark-layer-1 relative overflow-x-hidden'>
                ...
                <div className='w-full px-5 overflow-auto'>
                    ...
                    <div className='flex'>
                        ...
                        <div className='flex flex-wrap items-center gap-4'>
                            ...
                            hover:bg-dark-fill-2 relative rounded px-4 py-1 cursor-pointer whitespace-nowrap
                    ...
                    <div className='font-semibold my-4'>
                        ...
                        <p className='text-sm font-medium mt-4 text-white'>Onput:</p>
                        <div className='w-full cursor-text rounded-lg border px-3 py-[10px] bg-dark-fill-3 border-transparent text-white mt-2'>
            ...
            <EditorFooter handleSubmit={hannleSubmit}/>
        </div>
    );
};
