    ...
    return (
        <nav className='relative flex h-[50px] w-full shrink-0 items-center px-5 bg-dark-layer-1 text-dark-gray-7'>
            <div className={`flex w-full items-center justify-between ${!problemPage ? "max-w-[1200px] mx-auto" : ""}`}>
                <Link href='/' className='h-[35px] flex'>
                    <img src="/logo.png" alt="Logo" height={500} width={150} />
                </Link>
                {problemPage && (
                    <div className='flex items-center gap-4 flex-1 justify-center'>
                        <div className='flex items-center justify-center rounded bg-dark-fill-3 hover:bg-dark-layer-2 h-8 w-8 cursor-pointer'
                ...
                <div className='flex items-center space-x-4 flex-1 justify-end'>
                    <div>
                        <a 
                            href="https://www.buymecoffee.com/burakorkmezz"
                            target='_blank'
                            rel='noreferrer'
